...
const diagnostics: Record<string, string> = {
  ...
  waiting_for_sync: 'Todavía no hay un archivo válido disponible localmente. El flujo se ejecuta cada hora. Comprueba su historial y marca inbox como Siempre mantener en este dispositivo en OneDrive; Atlas volverá a comprobar cada 15 segundos.',
  different_installation_file: 'Hay archivos JSON, pero pertenecen a otro ZIP de Atlas. Ejecuta el flujo importado desde el ZIP de esta configuración o prepara de nuevo la configuración si ese flujo fue reemplazado.',
